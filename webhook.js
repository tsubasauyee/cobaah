...
const config = {
  channelAccessToken: 'UT9N2L9x2MRunL2fLdWYvJt2iZu/pydtuC032QT/BT8go7mm21sKGfIjs4j2CM7EUlw7JXzvsLlIQWWLZ7rSsolJSt1J1D6rlMYmrUQTt/RTJYFho/B5hY+F7DwN06Kn65xjbRj/SvFKhAqNnyW9hQdB04t89/1O/w1cDnyilFU=',
  channelSecret: '3771d0cb216985df9f15b513531e6aa8'
};
...
-------------------------------------------------------------------------------------------------------------
  */
  ...
  if(msg === '!reset')
  {
    client.getProfile(ei.source.userId).then((profile) =>
    {
      if(profile.displayName === 'Bot Has Been Reset')
      {
